  ...
  const contactInfo = [
    {
      ...
      title: 'Địa chỉ',
      content: '1000 Nguyễn Văn A, Thanh Khê, Đà Nẵng, Việt Nam',
      color: 'text-primary'
    },
    {
      icon: 'fas fa-phone',
      ...
      <div className="container py-5">
        ...
        <div className="mb-4">
          ...
          >
            ...
            Trang Chủ/
            <span className="fw-bold ms-1" style={{ fontSize: '16px' }}> Liên Hệ</span>
          </button>
        </div>
            ...
            <div className="card shadow-lg border-0" style={{ borderRadius: '20px' }}>
              ...
              <div className="card-body p-5">
                ...
                <div className="mt-5 pt-4 border-top">
                  <h5 className="fw-bold mb-4 text-center">Theo Dõi Chúng Tôi</h5>
