...
router.put('/cancel/:order_id', auth, userOnly, OrderController.cancelOrder); // User hủy đơn hàng
// Route cho admin
...
router.get('/stats/summary', auth, adminOnly, OrderController.getLifetimeSummary); // Thống kê tổng doanh thu, số đơn
